...
//  payroll summary
$sql_pay_summary = "SELECT * FROM payroll_summary WHERE cut_off = '13th Month' ORDER BY ID DESC";
...
<script>
function mnth_From(){
var txts = document.getElementById("months_from").value;
var yrs = document.getElementById("years_from").value;

$.ajax({
    url:"finds/months_from1.php",
    method: "POST",
    data:{
        idtms : txts,
        yrsms : yrs
...
// function Mnth_to(){
// var txt = document.getElementById("month_to").value;
// var yr = document.getElementById("year_to").value;

// $.ajax({
//     url:"finds/month_to.php",
//     method: "POST",
//     data:{
//         idt : txt,
//         yrs : yr
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h3 class="h2">13th Month Pay Summary</h3>
      </div>
        ...
        <div class="container table-responsive">
            ...
            ?>
                <div class="btnAdd">
                    <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#thMonthModal" class="btn btn-warning btn-sm">+ Create 13th Month Pay</a>
                    <a href="payroll_summary.php" class="btn btn-success btn-sm">Payroll Summary</a>
                </div>
                <p></p>
            ...
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                ...
                <form action="payroll_create_bonus.php" name="addData" method="post" autocomplete="off">
                    <div class="input-group">
                        ...
                        <select name="month_from" id="months_from" class="form-control" onchange="mnth_From()" required>
                        ...
                        <select name="year_from" id="years_from" class="form-control" onchange="mnth_From()" required>
                    ...
                    <p></p>
                    <div class="input-group" id="month_tos">
                        ...
                        <select name="" id="year_to" class="form-control" disabled>
                            <option value="" disabled selected hidden>Year</option>
                            <?php
                                if(isset($_SESSION['Bonus_Year_To'])){
                                    $yr_now = $_SESSION['Bonus_Year_To'];
                                }else{
                                    $yr_now = '';
                                }
                                echo '<option value="'.$yr_now.'" '.(!empty($yr_now) ? 'selected' : '').'>'.$yr_now.'</option>';
                            ?>
                        </select>
                        <input type="hidden" name="year_to" value="<?= $yr_now?>">
                    </div>
                    <p></p>
