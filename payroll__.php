...
<div class="containers">
    <h3>Payroll List</h3>
        <div class="contents">
                <a href="payroll.php?Payroll=Start">Start</a>
                <a href="payroll.php?Payroll=End">End</a>
                ...
                <?php
                    if(isset($_SESSION['dtr_From']) && isset($_SESSION['dtr_To']))
                    {
                        ...
                        $to = $_SESSION['dtr_To'];
                        ?>
                        <h4>Date Covered: <?php echo date('M d, Y', strtotime($from)).' - '.date('M d, Y', strtotime($to))?></h4>
                        <?php
                    }
                ?>
            <div class="payrolls">
                                    ...
                                    do{
                                        ...
                                        // dtr
                                            ...
                                            if($count > 0)
                                            {
                                                ...
                                                $total_hrs = $total_hrs + $hrs1;
                                                $total_ot = $total_ot + $hrs2;
                                            }

                                                // to verify hrs
                                                    if($hrs1 > 9 || $hrs1 < 7 || $hrs2 > 0)
                                                    {
                                                        $ver = "To Check";
                                                    }
