...
<div class="containers">
    <h3>Payroll for the Period of 
        ...
        <div class="contents">
                <div class="opt_start">
                    <a href="payroll.php?Payroll=Start" class="starts">Start</a>
                    <a href="payroll.php?Payroll=End" class="ends">End</a>
                </div>
 
                <form action="" method="post" class="pay_date">
                    <span>From:</span>
                    <input type="date" name="from" id="" value="<?php echo date('Y-m-d', strtotime($from))?>" required>
                    <span>To:</span>
                    <input type="date" name="to" id="" value="<?php echo date('Y-m-d', strtotime($to))?>" required>
                    <input type="submit" value="Details" name="details">

                <select name="dept" id="dept" onchange="selectedDeptPayroll()">
                    <option value="" disabled selected>Select Department</option>
                    <option value="">All</option>
                    <?php
                        do{
                            ?>
                                <option value="<?php echo $row_dept['dept'] ?>" <?php echo($row_dept['dept'] == $dept)? 'selected' : '' ?>><?php echo $row_dept['dept'] ?></option>
                            <?php
            ...
            <div id="payrolls" class="payrolls">
                <table>
                    <thead>
                        <tr>
                            <th rowspan="2">No.</th>
                                    ...
                                    do{
                                        ...
                                        $additional_pay = $ot_pay + $regular_holiday + $special_holiday + $day_off;
                                            ...
                                            <!-- Load Table details -->
                                                <tr>
                                                    <td><?php echo $no ?></td>
                                                    <td class="tdl"><?php echo $emp_name ?></td>
                                                    <td><?php echo round($total_hrs,2)?></td>
                                                    <td><?php echo number_format($basic_pay,2)?></td>
                                                    <td><?php echo round($additional_hrs,2)?></td>
                                                    <td><?php echo number_format($additional_pay,2)?></td>
                                                    ...
                                                    <td><?php echo $esf ?></td>
                                                    <td><?php echo $salary_loan ?></td>
                                                    <td><b><?php echo number_format($deductions,2)?></b></td>
                                                    <td><b><?php echo number_format($net_pay,2)?></b></td>
                                                    <td><a href="salary_sheet.php?ID=<?php echo $empID?>">Details</a></td>
                                                    <td><a href="dtr.php?ID=<?php echo $empID?>">DTR</a></td>
                                                </tr>
                                            <?php
                                        }
                                $no++;
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th colspan="2">
                                ...
                                ?>
                                    <a href="payroll.php?
                                            page=1"><img src="img/backward.png" alt="" width="10px"></a>
                                    <a href="payroll.php?
                                            page=<?php echo $prev?>"><img src="img/previous.png" alt="" width="10px"></a>
                                    <?php } ?>
                                    ...
                                    ?>
                                    <a href="payroll.php?
                                    page=<?php echo $next?>"><img src="img/next.png" alt="" width="10px"></a> 
                                    <a href="payroll.php?
                                    page=<?php echo $pp?>"><img src="img/forward.png" alt="" width="10px"></a>
                                <?php } ?>
                            </th>
                        </tr>
                    </tfoot>
            ...
            <?php
            include("prints/payroll_list.php");
            ?>

                <!-- <a href="print_employees_payroll.php" target="_blank">Print Employees Payroll</a> -->
                <a href="print_all_payslip.php" target="_blank">Print Payslip</a>
                <?php
                    if(isset($_SESSION['dtr_From']) && isset($_SESSION['dtr_To']))
                    {
                        $from = $_SESSION['dtr_From'];
                        $to = $_SESSION['dtr_To'];
                        ?>
                        <button onclick="exportTableToExcel('payroll_list_print', 'Payroll_list_<?php echo date('m/d/Y', strtotime($from)).' - '.date('m/d/Y', strtotime($to))?>')">Export To Excel File</button>
                        <?php
                    }else{
                        ?>
                        <button onclick="exportTableToExcel('payroll_list_print', 'Payroll_list')">Export To Excel File</button>
                        <?php
                    }
                ?>
        </div>
